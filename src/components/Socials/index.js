...
const Socials = (props) => {
  ...
  return (
    <div className='db dtc-ns black-70 tc tr-ns v-mid'>
      ...
      <a
        href='https://instagram.com/ab0elkassem' className='link hover-pink dib mr3 black-70'
      ...
      <a
        href='https://twitter.com/aboel_kassem' className='link hover-light-blue dib mr3 black-70' target='_blank'
      ...
      <a
        href='https://github.com/aboelkassem' className='link hover-black dib black-70' title='aboelkassem on Github'
        target='_blank'
        rel='noopener nofollow noreferrer'
      >
        <svg
       ...
       <a 
       href='https://www.linkedin.com/in/aboelkassem' className='link hover-blue dib black-70' target='_blank' style="margin-left:12px;"
