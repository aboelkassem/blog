const config = {
  ...
  siteUrl : `https://blog.aboelkassem.tech`, // Domain of your website without
                                             // pathPrefix.
  pathPrefix : '', // Prefixes all links. For cases when deployed to
                   // example.github.io/gatsby-starter-business/.
  siteDescription :
      `Aboelkassem blog is the personal blog of Mohamed Abdelrahman. My digital garden, a place to share my thoughts. A Brew of Awesomeness with a Pinch of Magic...`, // Website description used for RSS feeds/meta description tag.
  siteRss : `/rss.xml`,
  ...
  copyright : `Copyright © Aboelkassem Blog 2020-${
      new Date().getFullYear().toString().substr(
          2, 2)}. All Rights Reserved.`, // Copyright string for the footer of
                                         // the website and RSS feed.
  themeColor :
      `#676767`, // Used for setting manifest and progress theme colors.
  ...
  keywords :
      `aboelkassem, aboelkassem blog, mohamed abdelrahman, mohamed aboelkassem, blog aboelkassem`,
}
